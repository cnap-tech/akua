...
User-authored KCL programs are evaluated in a `wasm32-wasi` guest with zero I/O imports (see [embedded-engines.md §KCL sandboxing](embedded-engines.md#kcl-sandboxing--cli-vs-sdk)). A malicious KCL program cannot:
